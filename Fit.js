document.addEventListener('DOMContentLoaded', () => {
    ...
    const catalogData = [
        // Casual Tees
        { id: 1, name: "Classic Red Tee", category: "casual", price: 29.99, img: window.B64_IMAGES.red, hue: 0 },
        { id: 2, name: "Sunset Orange Tee", category: "casual", price: 29.99, img: window.B64_IMAGES.red, hue: 35 },
        { id: 3, name: "Ocean Blue Tee", category: "casual", price: 29.99, img: window.B64_IMAGES.red, hue: 200 },
        { id: 4, name: "Midnight Purple Tee", category: "casual", price: 29.99, img: window.B64_IMAGES.red, hue: 280 },
        { id: 5, name: "Charcoal Grey Tee", category: "casual", price: 29.99, img: window.B64_IMAGES.red, invertInfo: 'grayscale(1) brightness(0.6)' },
        
        { id: 6, name: "Forest Green V-Neck", category: "casual", price: 34.99, img: window.B64_IMAGES.green, hue: 0 },
        { id: 7, name: "Lime V-Neck", category: "casual", price: 34.99, img: window.B64_IMAGES.green, hue: -60 },
        { id: 8, name: "Aqua Blue V-Neck", category: "casual", price: 34.99, img: window.B64_IMAGES.green, hue: 120 },
        { id: 9, name: "Coral Pink V-Neck", category: "casual", price: 34.99, img: window.B64_IMAGES.green, hue: 220 },
        { id: 10, name: "Classic White V-Neck", category: "casual", price: 34.99, img: window.B64_IMAGES.green, invertInfo: 'grayscale(1) brightness(1.5)' },

        // Formal Shirts
        { id: 11, name: "Navy Dress Shirt", category: "formal", price: 49.99, img: window.B64_IMAGES.blue, hue: 0 },
        { id: 12, name: "Light Blue Dress Shirt", category: "formal", price: 49.99, img: window.B64_IMAGES.blue, invertInfo: 'brightness(1.5) hue-rotate(10deg)' },
        { id: 13, name: "Burgundy Oxford", category: "formal", price: 49.99, img: window.B64_IMAGES.blue, hue: 140 },
        { id: 14, name: "Emerald Dress Shirt", category: "formal", price: 49.99, img: window.B64_IMAGES.blue, hue: -100 },
        { id: 15, name: "Slate Grey Oxford", category: "formal", price: 49.99, img: window.B64_IMAGES.blue, invertInfo: 'grayscale(1)' },

        { id: 16, name: "Classic Red Plaid", category: "formal", price: 54.99, img: window.B64_IMAGES.plaid, hue: 0 },
        { id: 17, name: "Blue Checkered Flannel", category: "formal", price: 54.99, img: window.B64_IMAGES.plaid, hue: 210 },
        { id: 18, name: "Green Woods Flannel", category: "formal", price: 54.99, img: window.B64_IMAGES.plaid, hue: 100 },
        { id: 19, name: "Purple Ash Flannel", category: "formal", price: 54.99, img: window.B64_IMAGES.plaid, hue: 280 },
        { id: 20, name: "Monochrome Flannel", category: "formal", price: 54.99, img: window.B64_IMAGES.plaid, invertInfo: 'grayscale(1)' }
    ];
    ...
    function addClothingOverlay(src, filterStyle = 'none') {
        ...
        removeWhiteBackgroundFloodFill(src).then(transparentDataUrl => {
            ...
            loadingText.remove();
            alert("Error processing image background. Please ensure you are viewing this specific site through a local Web Server like 'VS Code Live Server' so image data is allowed by Security checks.");
            console.error(err);
        });
    }
    ...
    function removeWhiteBackgroundFloodFill(src) {
        return new Promise((resolve, reject) => {
            ...
            img.onerror = () => {
                ...
                reject("Failed to load. Security Error or missing image.");
            };
